...
A low residual is the expected y - actual y. So the lower the residual, the more accurate your expectation was. This means that our regression was pretty accurate. We understimated in San Jose which resulted in a negative residual which means that our expected y was much lower thaan the actual y. The furthest points North, South, and East were all overestimated. The expected y was higher than the actual y. The data we  got from our regression is similar to what the actual data shows. 
